...
{
    class Product // neyin ne olduğunu tanımlıyoruz
    {
    ...
    static class ProductManager
    {
        ...
        static ProductManager() //Depomuz
            {
                Products = new Product[5];

                Products[0] = new Product { ProductId = 1, ProductName = "Ipohone 5", Price = 2000, IsApproved = false };
